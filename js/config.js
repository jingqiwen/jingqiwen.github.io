...
const SITE_CONFIG = {
  ...
  research: {
    ...
    items: [
      { time: "2024.9.4 - 2024.9.17", name: "人生的第一个项目", role: "C语言学习 · 实验室学长带领", desc: "在刚入学军训期间，我在实验室学长的带领下，利用课余时间进行C语言的学习，一边写笔记一边在电脑上实践学习，运用Dev C++软件，并在9月17日完成了我人生中的第一个项目。当时第一次做，还有很多的bug，但是学长对我进行了耐心的指导。", images: ["assets/C1.jpg", "assets/C2.jpg", "assets/C3.jpg"], image: "", video: "", tags: ["C语言", "Dev C++", "第一个项目"] },
